...
{
    public class TPGlideState : TPBaseState
    {
        public TPGlideState(ThirdPersonController controller) : base(controller)
        {
        }
        ...
        public override void Update()
        {
            ...
            var fallSpeed = _controller.MovementProfile.Gravity * _controller.MovementProfile.GlideGravityMultiplier;
            _controller.Motor.SetGravity(fallSpeed);
            ...
            {
                var airSpeed = _controller.MovementProfile.WalkSpeed * _controller.MovementProfile.GlideControlMultiplier;

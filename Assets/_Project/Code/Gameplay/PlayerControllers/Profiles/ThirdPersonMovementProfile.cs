...
namespace _Project.Code.Gameplay.PlayerControllers.Profiles
{
    ...
    public class ThirdPersonMovementProfile : MovementProfile
    {
        ...
        [field: SerializeField, Header("Glide Settings"), Tooltip("Additional gravity multiplier when gliding")]
        public float GlideGravityMultiplier { get; private set; } = 0.5f;

        [field: SerializeField, Tooltip("Movement control multiplier while Glidig"), Range(0f, 1f)]
        public float GlideControlMultiplier { get; private set; } = 1f;
